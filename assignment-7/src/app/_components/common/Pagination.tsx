        ...
        <li key={curPage}>
          <Link
            ...
            className={`flex items-center justify-center text-sm py-2 px-3 leading-tight ${
              curPage === currentPage
                ? 'z-10 flex items-center justify-center px-3 h-8 leading-tight text-primary-600 border border-primary-300 bg-primary-50 hover:bg-primary-100 hover:text-primary-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white'
