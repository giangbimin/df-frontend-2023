...
class UserManagerService {
  ...
  public async register(user: RegisterUserType): Promise<RegisterResponseType> {
  ...
  public async login(user: UserType): Promise<LoginResponseType> {
  ...
  public async logout(): Promise<LogoutResponseType> {
