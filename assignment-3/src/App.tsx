...
const App: FC = () => {
  ...
  const [searchTerm, setSearchTerm] = useState<SearchTermType>(
    defaultSearchTermState,
  )
  const [bookStore, setBookStore] = useState<BooksType>(defaultBooksState)
  const [formCreate, setCreateForm] = useState<CreateFormStateType>(
    defaultFormCreateState,
  )
  const [formDelete, setDeleteForm] = useState<DeleteFormStateType>(
    defaultFormDeleteState,
  )
